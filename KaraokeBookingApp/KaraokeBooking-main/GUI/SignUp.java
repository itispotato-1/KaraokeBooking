...
import lib.loginregister.Passwordvalidation.*;
...
public class SignUp extends JPanel {
        ...
        private void initComponents() {
                ...
                JPanel panelImg = new JPanel(new FlowLayout(FlowLayout.CENTER, 0, 0));
                panelImg.setPreferredSize(new Dimension(100, 125));
                panelImg.setMaximumSize(new Dimension(100, 125));
