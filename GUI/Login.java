    ...
    private void initComponents() {
                ...
                jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        .addComponent(jPassOrNameWrong, GroupLayout.PREFERRED_SIZE, 189,
                                        ...
                                        .addGroup(
                                                jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                                        ...
                                                        .addComponent(pass)
                                                        .addComponent(jLabelLogin, GroupLayout.DEFAULT_SIZE, 322,
                                                                Short.MAX_VALUE)
                                                        .addComponent(user)))
        ...
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addGap(12, 12, 12)
                                .addComponent(jLabelUserName, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                        Short.MAX_VALUE)
                                ...
                                .addGap(14, 14, 14)
                                .addComponent(jLabelLogin, GroupLayout.PREFERRED_SIZE, 42, GroupLayout.PREFERRED_SIZE)
                                .addGap(14, 14, 14)));
        ...
        P1Layout.setHorizontalGroup(
                P1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(P1Layout.createSequentialGroup()
                                .addGap(30)
                                .addComponent(jPanelLineLeft, GroupLayout.PREFERRED_SIZE, 99,
                                        GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(P1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(P1Layout.createSequentialGroup()
                                                ...
                                                .addComponent(jPanelLineRight, GroupLayout.PREFERRED_SIZE, 99,
                                                        GroupLayout.PREFERRED_SIZE))
                                        .addComponent(jLabelImageK2, GroupLayout.PREFERRED_SIZE, 111,
                                                GroupLayout.PREFERRED_SIZE))
                ...
                P1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(P1Layout.createSequentialGroup()
                                .addGroup(P1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        .addGroup(P1Layout.createSequentialGroup()
                                                .addGap(20)
                                                .addComponent(jLabelImageLogo, GroupLayout.PREFERRED_SIZE, 98,
                                                        GroupLayout.PREFERRED_SIZE)
                                                .addGroup(P1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                                        .addGroup(P1Layout.createSequentialGroup()
                                                                .addComponent(jLabelLogIn)
                                                                .addGap(24, 24, 24))
                                                        .addGroup(GroupLayout.Alignment.LEADING, P1Layout
                                                                .createSequentialGroup()
                                                                .addGap(30, 30, 30)
                                                                .addComponent(jPanelLineLeft, GroupLayout.PREFERRED_SIZE,
                                        ...
                                        .addGroup(P1Layout.createSequentialGroup()
                                                .addGap(148)
                                                .addComponent(jPanelLineRight, GroupLayout.PREFERRED_SIZE, 12,
                                                        GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED,
                                                        GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                                .addComponent(jLabelImageK2, GroupLayout.PREFERRED_SIZE, 81, GroupLayout.PREFERRED_SIZE)
                                .addGap(0)
                                .addComponent(jPanel1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                        GroupLayout.PREFERRED_SIZE)
                                .addGap(0)
                                .addComponent(jButtonLogin, GroupLayout.PREFERRED_SIZE, 42, GroupLayout.PREFERRED_SIZE)
                                .addGap(90)));
