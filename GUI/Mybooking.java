...
public class Mybooking extends JPanel {
        ...
        private void initComponents() {
                ...
                // jPanel1Layout.createSequentialGroup()
                // .addComponent(jMyBooking, GroupLayout.PREFERRED_SIZE, 121,
                // GroupLayout.PREFERRED_SIZE)
                // .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                // .addComponent(jBookingButton, GroupLayout.PREFERRED_SIZE, 118,
                // GroupLayout.PREFERRED_SIZE)
                // .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                // .addComponent(jOrderFood, GroupLayout.PREFERRED_SIZE, 118,
                // GroupLayout.PREFERRED_SIZE))
                // .addComponent(jTopUp, GroupLayout.Alignment.LEADING,
                ...
                // GroupLayout.PREFERRED_SIZE)
                // .addComponent(jLabelBookRoom, GroupLayout.PREFERRED_SIZE, 25,
                // GroupLayout.PREFERRED_SIZE)))
                // .addGap(14, 14, 14)
                // .addComponent(jPanel11, GroupLayout.PREFERRED_SIZE,
                // GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                ...
                // .addComponent(jMyBooking, GroupLayout.PREFERRED_SIZE, 42,
                // GroupLayout.PREFERRED_SIZE)
                // .addComponent(jBookingButton, GroupLayout.PREFERRED_SIZE, 42,
                // GroupLayout.PREFERRED_SIZE)
                // .addComponent(jOrderFood, GroupLayout.PREFERRED_SIZE, 42,
                // GroupLayout.PREFERRED_SIZE))
                // .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                // .addComponent(jTopUp, GroupLayout.PREFERRED_SIZE, 42,
                // GroupLayout.PREFERRED_SIZE)
                // .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
        ...
        private void loadRoom() {
                try {
                        ...
                        while ((tempS = br.readLine()) != null) {
                                ...
                                ModelList1.addElement(tempSplit[0] + " Date : "+tempSplit[2] +" - "+tempSplit[3]);
                        }
                } catch (Exception e) {
