...
public class menudrink extends JPanel {
    ...
    private JLabel jLabelNameDrink[];
    ...
    public menudrink(Mainframe mainframe) {
        ...
        jLabelNameDrink = new JLabel[100];
    ...
    private void initComponents() {
        ...
        jButtonFood.setFont(FontTWCENMT.deriveFont((float) 28).deriveFont((int) 1));
        ...
        jButtonDrink.setFont(FontTWCENMT.deriveFont((float) 28).deriveFont((int) 1));
        ...
        JPanel panelMenuDrink = new RoundedPanel(40, 40);
        panelMenuDrink.setLayout(null);
        panelMenuDrink.setBackground(Color.BLACK);
        panelMenuDrink.setBounds(35, 130, 370, 475);

        JLabel jLabelMenuDrink = new JLabel();
        jLabelMenuDrink.setForeground(Color.WHITE);
        jLabelMenuDrink.setFont(FontTWCENMT.deriveFont((float) 35).deriveFont((int) 1));
        jLabelMenuDrink.setText("MENU DRINK");
        jLabelMenuDrink.setBounds(90, 2, 300, 50);

        panelOrder = new RoundedPanel(30, 30);
        ...
        panelMenuDrink.add(scroll);
        // ----------------------------- Setup Drink --------------------------------

        panelMenuDrink.add(jLabelMenuDrink);

        panelMain.add(panelMenuDrink);
    ...
    private void setUpDrink() {
        ...
        for (Product product : mainframe.getProductSystem().getAllProducts()) {
            if (product.getProductId().charAt(0) == 'D') {
                ...
                jLabelNameDrink[i] = new JLabel(product.getProductName());
                jLabelNameDrink[i].setFont(FontTWCENMT.deriveFont((float) 14).deriveFont(1));
                jLabelNameDrink[i].setBounds(10, 80, 100, 70);
                ...
                ButtonOrder[i].putClientProperty(1,
                        new Product(product.getProductId(), product.getProductName(), product.getPrice()));
                ...
                panelOrderIn[i].add(jLabelNameDrink[i]);
